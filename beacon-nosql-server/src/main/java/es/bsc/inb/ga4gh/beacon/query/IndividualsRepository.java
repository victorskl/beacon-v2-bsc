...
public interface IndividualsRepository 
        extends Repository<IndividualEntity, String> {

    @Override
    @Query("select * from Individuals where id = @id")
    public Optional<IndividualEntity> findById(@Param("id") String id);
    
    List<IndividualEntity> findAll();
    
    List<IndividualEntity> findAll(Pagination pagination);
}
